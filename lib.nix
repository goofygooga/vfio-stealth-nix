  ...
  mkStealthFeatures =
    ...
    }:
    {
      ...
      qemuArgs =
        ...
        # tables generated by smbios/generate-tables.py bypass this limitation.
        #
        ...
        # APERF/MPERF: defeats IET-based VM detection by passing
        # IA32_APERF/MPERF MSRs directly to guest. Requires kernel 6.18+
        # (KVM_X86_DISABLE_EXITS_APERFMPERF) + QEMU APERF/MPERF backport
        # (applied in qemu/package.nix postPatch) + -overcommit cpu-pm=on
